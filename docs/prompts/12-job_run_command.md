...
## Task Overview
You are implementing the `job_run_command` from the Logist master development plan. Consult this prompts file throughout implementation to ensure every requirement is met - reference it explicitly after each major step to verify compliance.
